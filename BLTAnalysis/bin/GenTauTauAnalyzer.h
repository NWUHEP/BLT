...
//Tool to analyze the generator level distributions of e/mu+tau events

#ifndef GenTauTauAnalyzer_HH
#define GenTauTauAnalyzer_HH
...
class GenTauTauAnalyzer: public BLTSelector {
public:
    GenTauTauAnalyzer();
    ~GenTauTauAnalyzer();
