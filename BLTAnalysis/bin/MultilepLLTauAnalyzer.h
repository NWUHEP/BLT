...
#ifndef MultilepLLTauAnalyzer_HH
#define MultilepLLTauAnalyzer_HH
...
class MultilepLLTauAnalyzer: public BLTSelector {
public:
    MultilepLLTauAnalyzer();
    ~MultilepLLTauAnalyzer();
...
#endif  // MultilepLLTauAnalyzer_HH
