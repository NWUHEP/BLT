...
hzgAnalyzer2017::hzgAnalyzer2017() : BLTSelector()
{

}

hzgAnalyzer2017::~hzgAnalyzer2017()
{

}

void hzgAnalyzer2017::Begin(TTree *tree)
{
...
Bool_t hzgAnalyzer2017::Process(Long64_t entry)
{
...
void hzgAnalyzer2017::Terminate()
{
    outFile->Write();
    outFile->Close();
...
void hzgAnalyzer2017::ReportPostBegin()
{
...
void hzgAnalyzer2017::ReportPostTerminate()
{
...
{
    std::unique_ptr<hzgAnalyzer2017> selector(new hzgAnalyzer2017());
...
float hzgAnalyzer2017::GetMuonIsolation(const baconhep::TMuon* mu)
{
...
float hzgAnalyzer2017::GetElectronIsolation(const baconhep::TElectron* el, const float rho)
{
    int iEta = 0;
...
float hzgAnalyzer2017::GetPhotonIsolation(const baconhep::TPhoton* pho, const float rho)
{
    int iEta = 0;
    float etaBins[8] = {0., 1., 1.479, 2.0, 2.2, 2.3, 2.4, 2.5};
    float effArea[8] = {0.1703, 0.1715, 0.1213, 0.1230, 0.1635, 0.1937, 0.2393};
