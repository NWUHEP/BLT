...
#ifndef HZGANALYZERUCSBSYNC_HH
#define HZGANALYZERUCSBSYNC_HH
...
class hzgAnalyzerUCSBSync: public BLTSelector {
public:
    hzgAnalyzerUCSBSync();
    ~hzgAnalyzerUCSBSync();
    ...
    //ClassDef(hzgAnalyzerUCSBSync,0);
};

#endif  // HZGANALYZERUCSBSYNC_HH
