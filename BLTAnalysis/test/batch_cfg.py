...
selection  = 'mumu' #'ee' 'emu'
period     = '2016'

data_samples = ['single_mu']#, 'single_el']
mc_samples   = ['zjets',  'ttbar','t', 'signal'] # 'diboson', 'wjets', 'qcd'
...
mc_dict['signal'] = [
    cfg(data_name = 'btag_B2bX_t',
        path     = '{0}/Summer16_bTag_B2bX_t_Pythia8'.format(path),
        nJobs    = 1,
        suffix   = 'b2bx_t'
       ),
    cfg(data_name = 'BB2bbdimu',
        path     = '{0}/Summer16_BB2bbdimufatjet_Pythia8'.format(path),
        nJobs    = 1,
        suffix   = 'bb2bbdimu'
       ),
    cfg(data_name = 'FCNC_MX10',
        path     = '{0}/Summer16_FCNC_MX10GeV'.format(path),
        nJobs    = 1,
        suffix   = 'fcnc_mx10'
       ),
    cfg(data_name = 'FCNC_MX30',
        path     = '{0}/Summer16_FCNC_MX30GeV'.format(path),
        nJobs    = 1,
        suffix   = 'fcnc_mx30'
       ),
    cfg(data_name = 'FCNC_MX60',
        path     = '{0}/Summer16_FCNC_MX60GeV'.format(path),
        nJobs    = 1,
        suffix   = 'fcnc_mx60'
       ),
    ]
...
batch = bm.BatchMaster(config_list = batch_list, 
                       stage_dir   = 'batch',
                       output_dir  = '/store/user/'+os.environ["USER"]+'/batch_output',
                       selection   = selection,
                       period      = period,
